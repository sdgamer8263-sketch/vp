        ...
        <div className="bg-black/50 backdrop-blur-md rounded-xl shadow-xl border border-white/10 overflow-hidden md:col-span-2">
          ...
          <div className="p-6">
            ...
            <div className="border-t border-white/10 pt-6">
              <h4 className="text-white font-medium mb-2">Automatic Blueprint Installation</h4>
              <p className="text-sm text-gray-400 mb-4">
                This script will automatically generate the Blueprint extension on your server and install it safely without breaking your panel.
              </p>
              <div className="bg-black/80 p-4 rounded-lg font-mono text-sm text-blue-400 overflow-x-auto border border-white/5 mb-4">
                <code>
                  wget -qO blueprint-setup.sh {window.location.origin}/blueprint-setup.sh && bash blueprint-setup.sh
                </code>
              </div>
              <a 
                href="/blueprint-setup.sh" 
                download="blueprint-setup.sh"
              ...
              >
                ...
                <span>Download blueprint-setup.sh</span>
              </a>
            </div>
          </div>
        </div>
