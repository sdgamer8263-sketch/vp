      ...
      <div className="flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-2 bg-black/40 p-1 rounded-lg border border-white/5">
            <button
              ...
              className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all ${
                viewMode === 'user' ? 'bg-white/20 shadow-sm text-white' : 'text-gray-400 hover:text-gray-200'
              }`}
            >
              User View
            </button>
            <button
              ...
              className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all ${
                viewMode === 'admin' ? 'bg-white/20 shadow-sm text-white' : 'text-gray-400 hover:text-gray-200'
              }`}
            >
              Admin View
            </button>
        ...
        <div className="flex items-center space-x-4 border-l border-white/10 pl-6">
          ...
          <div className="flex items-center space-x-2 cursor-pointer">
            <div className="w-8 h-8 rounded-full flex items-center justify-center text-white font-bold shadow-lg" style={{ backgroundColor: theme.primary }}>
              {role === 'Admin' ? 'A' : 'U'}
            </div>
